import { DeleteOutlined, EditOutlined, UploadOutlined, UserOutlined, UserSwitchOutlined } from "@ant-design/icons";
    ...
    },
    {
      ...
      render: (_: any, row: any) => <>
        <Space>
          ...
          <NavLink to={`${row.id}/cast`}><Button shape="circle" icon={<UserOutlined />} /></NavLink>
          <NavLink to={`${row.id}/crew`}><Button shape="circle" icon={<UserSwitchOutlined />} /></NavLink>
        </Space>
      </>
    },
  ];
